"""Frozen RealNVP TSP-20 baseline v1.

This file is an immutable reference copy of the original TSP-20 RealNVP
experiment before later schedule/checkpoint/elite-training experiments.
...
- checkpoint selected by validation mean

Do not modify this file for new experiments. Create a new experiment file
instead so comparisons remain reproducible.
"""
